...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-rc-border bg-rc-bg/50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-rc-muted leading-relaxed max-w-xs">
              AI-powered review response and reputation management for businesses that care about their customers.
            </p>
          </div>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="text-sm font-semibold text-rc-text mb-4">
                {category}
              </h4>
        ...
        <div className="mt-12 pt-8 border-t border-rc-border flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="#"
              className="text-rc-muted hover:text-rc-text transition-colors"
              aria-label="Twitter"
            >
