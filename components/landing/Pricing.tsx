...
export default function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      price: "₹1,499",
      period: "/mo",
      description: "For growing businesses that need more power & insights.",
      features: [
        "3 locations",
        "All platforms",
    ...
    },
    {
      ...
      price: "₹3,999",
      period: "/mo",
      description: "For agencies managing multiple client reputations.",
      features: [
        "10 locations",
        "White-label branding",
        "API access",
        "Dedicated account manager",
        "Custom AI tone per client",
        "Team collaboration",
      ],
      cta: "Get Started",
      popular: false,
