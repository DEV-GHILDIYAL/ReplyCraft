  ...
  return (
    <div>
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-rc-text">Create your account</h1>
      ...
      <div className="relative my-6">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-rc-border" />
        </div>
        <div className="relative flex justify-center text-xs">
          <span className="bg-rc-card px-3 text-rc-muted">
      ...
      <form onSubmit={handleRegister} className="space-y-4">
        <div>
          <label htmlFor="fullName" className="block text-sm font-medium text-rc-muted mb-1.5">
            Full Name
          </label>
          <input
            id="fullName"
        ...
        <div>
          <label htmlFor="registerEmail" className="block text-sm font-medium text-rc-muted mb-1.5">
            Email
          </label>
          <input
            id="registerEmail"
        ...
        <div>
          <label htmlFor="registerPassword" className="block text-sm font-medium text-rc-muted mb-1.5">
            Password
          </label>
          <input
            id="registerPassword"
        ...
        <div>
          <label htmlFor="businessName" className="block text-sm font-medium text-rc-muted mb-1.5">
            Business Name
          </label>
          <input
            id="businessName"
        ...
        <label className="flex items-start gap-3 cursor-pointer group">
          <input
            ...
            className="mt-0.5 h-4 w-4 rounded border-rc-border bg-rc-bg/50 text-rc-accent focus:ring-rc-accent/30 focus:ring-offset-0"
          />
